...
namespace WebScrappingBase.ScrappingInteraction
{
    public static class ScrappingLoginPage
    {
        public static async Task<string> OpenMainPage(Page page)
        {
            ...
            try
            {
                var response = await page.GoToAsync(AppConstants.homeUrl, timeout: 0); Console.Write(AppConstants.homeUrl);
